(* OASIS_START *)
(* DO NOT EDIT (digest: efad6f33cd70f287d4e0aaf6c5fb6ffd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2015-2016 Jane Street Group LLC <opensource@janestreet.com>"
            ];
          maintainers =
            ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          authors = ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          homepage = Some "https://github.com/janestreet/ppx_optcomp";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "bin";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ppx_optcomp"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "optcomp.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\215uO\226\027\018a>\165\184\r\167\139\199W\236";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
